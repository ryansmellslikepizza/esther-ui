...
export function DescriptionTerm({ className, ...props }: React.ComponentPropsWithoutRef<'dt'>) {
  return (
    <dt
      ...
      className={clsx(
        className,
        'col-start-1 border-t pt-3 text-zinc-500 first:border-none sm:border-t sm:py-3 border-white/5 text-zinc-400 sm:border-white/5'
      )}
    />
  )
}
...
export function DescriptionDetails({ className, ...props }: React.ComponentPropsWithoutRef<'dd'>) {
  return (
    <dd
      ...
      className={clsx(
        className,
        'pt-1 pb-3 border-t sm:py-3 sm:nth-2:border-none dark:text-white sm:border-white/5'
      )}
    />
  )
}
